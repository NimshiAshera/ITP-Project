...
public class FList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "select fname,lname,pass,phone,gender,email from fcustomer";
			...
			String st1 ="<table class=\"new\" border=2; width=100%;><tr class=\"tab\"><th class=\"col1\">First Name</th><th class=\"col2\">Last Name</th><th class=\"col3\">Passport</th><th class=\"col4\">Contact No.</th><th class=\"col5\">Gender</th><th class=\"col6\">Email</th></tr>";
