 ...
 */
@WebServlet("/userDetailsST")
public class userDetailsST extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public userDetailsST() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			request.getRequestDispatcher("/getUserT.jsp").forward(request,response);
			request.getRequestDispatcher("/getTour.jsp").forward(request,response);
		}
		catch(Exception p){
