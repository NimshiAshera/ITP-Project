	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			while(rs.next()){
				...
				platinum.setView(rs.getString(4));
				platinum.setBed(rs.getString(5));
				platinum.setAvatar(rs.getString(6));
				platinum.setPath(rs.getString(7));
				platinum.setD1(rs.getString(8));
				platinum.setD2(rs.getString(9));
				platinum.setD3(rs.getString(10));
				platinum.setD4(rs.getString(11));
				platinum.setD5(rs.getString(12));
				platinum.setD6(rs.getString(13));
				platinum.setD7(rs.getString(14));
			}
			System.out.println("worked");
