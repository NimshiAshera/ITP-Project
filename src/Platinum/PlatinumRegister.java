...
public class PlatinumRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		platinum.setView(request.getParameter("view"));
		...
		if (conn == null) {
			...
			try {
				...
				if (rs.next()) {
					...
					String sql2 = "insert into platinum (pname,pid,person,view,bed,avatar,path,d1,d2,d3,d4,d5,d6,d7)"
							+ "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
					...
					pre.setString(4, platinum.getView());
					pre.setString(5, platinum.getBed()); 
					...
					pre.setString(6, platinum.getAvatar());
					pre.setString(7, platinum.getPath());
					pre.setString(8, platinum.getD1());
					pre.setString(9, platinum.getD2());
					pre.setString(10, platinum.getD3());
					pre.setString(11, platinum.getD4());
					pre.setString(12, platinum.getD5());
					pre.setString(13, platinum.getD6());
					pre.setString(14, platinum.getD7());
