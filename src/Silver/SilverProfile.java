...
public class SilverProfile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = "select pname,pid,person,view,bed,d1,d2,d3 from silver where pid = '"+silver.getPid()+"'";
			...
			while(rs.next()){
				...
				silver.setD1(rs.getString(6));
				silver.setD2(rs.getString(7));
				silver.setD3(rs.getString(8));
