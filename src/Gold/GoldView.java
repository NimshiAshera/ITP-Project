...
public class GoldView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = "select pname,person,view,bed,avatar,d1,d2,d3,d4,d5 from gold ";
    		...
    		out.println("<h1>View Registered Gold Packages</h1>");
			
    		out.print("<table border><tr><th>100 USD Valued Silver Package</th></tr></table>");
    		
    		String st1 ="<table border=2; width=200%;><tr><th>Name</th><th>No of Person </th><th>View</th><th>Bed</th><th>Image</th><th>Day 1</th><th>Day 2</th><th>Day 3</th><th>Day 4</th><th>Day 5</th><th>Book Package</th></tr>";
			
    		
    		while(rs.next()){
    			
    			out.print("<br/><br/><br/>");  
    			st1 += "<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+"<img src=\"package/"+rs.getString(5)+"\" width=\"300\" height=\"200\">"+"</td><td>"+rs.getString(6)+"</td><td>"+rs.getString(7)+"</td><td>"+rs.getString(8)+"</td><td>"+rs.getString(9)+"</td><td>"+rs.getString(10)+"</td><td><a href=\"packageBooking.jsp\" class=\"btn btn-danger ml-2 btn-sm\"><i class=\"fas fa-spinner\"></i><font size=\"4\"> Booking</font></a></td></tr>\r\n" + 
    					"</tr>";
