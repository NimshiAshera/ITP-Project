...
<h1 style="text-align: center; font-size: 50px; color: green">Update Customer Profile</h1>
		...
		<div class="form-style-5">
			<div class="form">
				<form action="UpdateFCustomer" method="post" enctype="multipart/form-data">
																
					
						<lable>First Name</lable>
						<p><input id="input" type="text"
							value='<%=fcustomer.getFname() %>' name="fname"></p>
						...
						<p><input id="input" type="text"
							value='<%=fcustomer.getUname() %>' name="uname" disabled="disabled"></p>
		...
		function myFunction() {
		    if (confirm("THINK TWICE ! If you pressed \"ok\" your user account will be deleted permanently..")) {
    			window.location.href = "DeleteFCustomer";
    		} else {
