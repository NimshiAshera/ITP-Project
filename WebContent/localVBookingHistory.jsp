	...
	<h1>View Booked Vehicles</h1>
		...
		<br/><br/>
     	...
     	<div class="table100">
            ...
            if(query!=null){
            	data = "select l.fname,l.phone, l.email ,v.vname, v.date, v.numd, v.amount  from vehiclebook v INNER JOIN lcustomer l  on l.username = v.username where v.vname like '% "+ query +" %' or   l.fname like '% "+query+" %' ";
            }else{
            	data = "select l.fname,l.phone, l.email ,v.vname, v.date, v.numd, v.amount  from vehiclebook v INNER JOIN lcustomer l  on l.username = v.username where date < current_date()";
            }
