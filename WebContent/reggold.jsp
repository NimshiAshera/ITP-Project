...
<meta charset="ISO-8859-1">
    ...
    <body class="w3-#e6ffee" style="background-color: #e6ffee">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px; background-color: light-grey">
			...
			<form action="GoldRegister" name="form1" method="post" enctype="multipart/form-data" onSubmit="return validation()">
	
			<i style='font-size:48px' class='fas'>&#xf183;</i><font color ="#00cc7a" size="8"> Gold Registration</font>
