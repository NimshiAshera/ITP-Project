...
<h1 style="text-align: center; font-size: 50px; color: green">Update Profile</h1>
		...
		<div class="form-style-5">
			<div class="form">
				<form action="UpdateAdventure2" method="post" enctype="multipart/form-data">
						...
						<p><input id="input" type="text"
					 	...
					 	<lable>Contact Person No.</lable>
						<p><input name="contact_no" placeholder="Contact No" type="text"></p>
						
					 	<lable>Details</lable>
						<p><textarea name="Details" placeholder="" type="text"></textarea></p>
						
						<lable>Best Season</lable>
						<p><textarea name="season" placeholder="" type="text"></textarea></p>
						
						<lable>What can be seen?</lable>
						<p><textarea name="see" placeholder="" type="text"></textarea></p>
						
 						<lable>How long is the trip?</lable>
						<p><textarea name="time" placeholder="" type="text"></textarea></p>          	
