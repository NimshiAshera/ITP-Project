...
<title>Adventure Image Update</title>
...
<h1 style="text-align: center; font-size: 50px; color: green">Update Image</h1>
		<br> <br><br> <br>
		<%
		...
		<div class="form-style-5">
			<div class="form">
				<form action="UpdateAdventureImage" method="post" enctype="multipart/form-data">
