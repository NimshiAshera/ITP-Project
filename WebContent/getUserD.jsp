		...
		<div  class="userDetailsVS" align="center">
			<table border="5" style="border-color:white" cellpadding="12">
				...
				<tr style="color:black">
					...
					<th style="color:black"><font size="10px">Driver Name</font></th>
				...
				<tr  style="color:black">
					<td  style="color:black"><font size="10px"><%=driver.getUsername()%></font></td>
					<td  style="color:black"><font size="10px"><%=driver.getdname()%></font></td>
					<td  style="color:black"><font size="10px"><%=driver.getdate()%></font></td>
					<td  style="color:black"><font size="10px"><%=driver.getnumd()%></font></td>
					<td  style="color:black"><font size="10px"><%=driver.getprice()%></font></td>
					<td  style="color:black"><font size="10px"><%=driver.getamount()%></font></td>
