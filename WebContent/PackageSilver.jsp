                ...
                <div class="w3-row"  ;">
                    <div class="w3-col w3-center" >
						...
						<a href="regsilver.jsp">
                                <div class="w3-col ">
                                    <div class="w3-container w3- w3-padding-24  w3-hover-dark-gray" style="background-color: #cccccc">
                                        ...
                                        <div class="w3-right  w3-padding">
                                            <h3>Insert New Silver Package</h3>
                                        </div>
                                    </div>
                                </div>
                         </a>
                         <a href="SilverList">
                                <div class="w3-col ">
                                    <div class="w3-container w3- w3-padding-24  w3-hover-dark-gray" style="background-color: #b3b3b3">
                                        <div class="w3-left w3-padding"><i class="fas fa-box-open w3-xxxlarge"></i></div>
                                        <div class="w3-right  w3-padding">
                                            <h3>View Silver Packages</h3>
                                        </div>
                                    </div>
                                </div>
                            </a>							
