	...
	<br><br><br>
					...
					<div id="main">
    					<div id="box">
							...
							<br/><br/>	
							<h1 align="center"><b>Details of <%=guide.getFname()%> <%=guide.getLname()%></b></h1>
							...
							<div id="social"> 
									...
									<div class="low">
											...
											<br/>
												...
												<a href="localGBooking.jsp"><input type="submit" value="View Local Customer Bookings" class="select-button" /></a>		
									...
									<div class="low">
											...
											<br/>
												...
												<a href="foreignGBooking.jsp"><input type="submit" value="View Foreign Customer Bookings" class="select-button" /></a>	
