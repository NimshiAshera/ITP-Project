...
<body>
	...
	<div>
     	...
     	<div class="table100">
            ...
            String query = request.getParameter("vname");
            String data;

            if(query!=null){
            	data = "select f.fname,f.phone, f.email ,v.vname, v.date, v.numd, v.amount  from vehiclebook v INNER JOIN fcustomer f  on f.username = v.username where v.vname like '% "+ query +" %' or   f.fname like '% "+query+" %' ";
            }else{
            	data = "select f.fname,f.phone, f.email ,v.vname, v.date, v.numd, v.amount  from vehiclebook v INNER JOIN fcustomer f  on f.username = v.username where date < current_date()";
            }
