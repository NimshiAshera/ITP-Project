...
<body>
	...
	<h1>View Booked Drivers</h1>
	
	<br/><br/>
	
		<div class="new">
		 		<form action=""  method="get">
		 		<input type="text" class="form-control" name="q" placeholder="Enter vehicle owner name to search your bookings..."/>
		...
		<br/><br/>
     	...
     	<div class="table100">
            ...
            if(query!=null){
            	data = "select l.fname,l.phone, l.email ,d.dname, d.date, d.numd, d.amount  from driverbook d INNER JOIN lcustomer l  on l.username = d.username where d.dname like '% "+ query +" %' or   l.fname like '% "+query+" %' ";
            }else{
            	data = "select l.fname,l.phone, l.email ,d.dname, d.date, d.numd, d.amount  from driverbook d INNER JOIN lcustomer l  on l.username = d.username ";
            }
