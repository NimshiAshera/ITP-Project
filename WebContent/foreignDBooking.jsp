	...
	<br/><br/>
		...
		<br/><br/>
     	...
     	<div class="table100">
            ...
            if(query!=null){
            	data = "select f.fname,f.phone, f.email ,d.dname, d.date, d.numd, d.amount  from driverbook d INNER JOIN fcustomer f  on f.username = d.username where d.dname like '% "+ query +" %' or   f.fname like '% "+query+" %' ";
            }else{
            	data = "select f.fname,f.phone, f.email ,d.dname, d.date, d.numd, d.amount  from driverbook d INNER JOIN fcustomer f  on f.username = d.username ";
            }
