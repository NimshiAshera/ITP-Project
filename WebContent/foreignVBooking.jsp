...
<body>
	...
	<div>
		...
		<div class="new">
		 		<form action="FVehicleSearch" class="example"  >
		...
		<br/><br/>
     	...
     	<div class="table100">
        			...
        			<Thead>
            			<TR>
               				<TH class="cell100 column1">Customer First Name</TH>
            ...
            String data = "select f.fname,f.phone, f.email ,v.vname, v.date, v.numd, v.amount  from vehiclebook v INNER JOIN fcustomer f  on f.username = v.username where date > current_date()";
       ...
       <br/><br/> 
        <a href="foreignVBookingHistory.jsp"><button class="button" >View History</button></a>
