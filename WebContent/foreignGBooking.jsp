...
<body>
	...
	<br/><br/>
		...
		<div class="new">
		 		<form action="FGuideSearch"  method="get">
		...
		<br/><br/>
     	...
     	<div class="table100">
            ...
            if(query!=null){
            	data = "select f.fname,f.phone, f.email , g.gname, g.date, g.numd, g.amount  from tourguidebook g INNER JOIN fcustomer f  on f.username = g.username where g.gname like '% "+ query +" %' or   f.fname like '% "+query+" %' ";
            }else{
            	data = "select f.fname,f.phone, f.email ,g.gname, g.date, g.numd, g.amount  from tourguidebook g INNER JOIN fcustomer f  on f.username = g.username ";
            }
