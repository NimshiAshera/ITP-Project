		...
		<div id="main">
    		<div id="box">
        		...
        		<img src="driver/<%=driver.getAvatar() %>"  >
         		...
         		<h1 align="center"><b>Details of <%=driver.getFname()%> <%=driver.getLname()%></b></h1>
				...
				<h3 style="font-size:20px;">Password :<%=driver.getPassword()%></h3><br/>
        		...
        		<div id="social"> 
					...
					<div class="low">
											...
											<br/>
												...
												<a href="localDBooking.jsp"><input type="submit" value="View Local Customer Bookings" class="select-button" /></a>		
									...
									<div class="low">
											...
											<br/>
												...
												<a href="foreignDBooking.jsp"><input type="submit" value="View Foreign Customer Bookings" class="select-button" /></a>	
