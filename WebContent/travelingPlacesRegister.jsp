...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="Home.jsp" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">MERCH</a>
	...
	<form action="TravellingPlaceReg" method="post">
	...
	<br>
                                ...
                                <p><input type="text" class="form-control"  name="name" placeholder=" Name"  ></p>
                               	...
                               	<p> <input type="text" class="form-control" name="price" placeholder="Details"  ></p>
                            
                            
                            	<label>Upload Image</label>
                                <p><input  type="file" name="image" ></p><br/>
                                
                                
                                <label>Upload Location</label>
                                <p><input  type="image" name="map" ></p><br/>
