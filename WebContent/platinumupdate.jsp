...
<meta charset="ISO-8859-1">
    ...
    <body class="w3-#e6ffee" style="background-color: #e6ffee">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px; background-color: light-grey">
			...
			<i style='font-size:48px' class='fas'>&#xf183;</i><font color ="#00cc7a" size="8"> Platinum Update</font>
			
		
		<div class="form-style-5">
			<div class="form">
				<form action="UpdatePlatinum" method="post" enctype="multipart/form-data">
						...
						<p><input id="input" type="text"
					 	...
					 	<lable>Day 1</lable>
						<p><textarea id="input" type="text"
							value="d1" name="d1" ></textarea></p>	
							
						<lable>Day 2</lable>
						<p><textarea id="input" type="text"
							value="d2" name="d2" ></textarea></p>	
							
						<lable>Day 3</lable>
						<p><textarea id="input" type="text"
							value="d3" name="d3" ></textarea></p>	
							
						<lable>Day 4</lable>
						<p><textarea id="input" type="text"
							value="d4" name="d4" ></textarea></p>	
							
						<lable>Day 5</lable>
						<p><textarea id="input" type="text"
							value="d5" name="d5" ></textarea></p>
							
						<lable>Day 6</lable>
						<p><textarea id="input" type="text"
							value="d6" name="d6" ></textarea></p>	
							
						<lable>Day 7</lable>
						<p><textarea id="input" type="text"
							value="d7" name="d7" ></textarea></p>							
