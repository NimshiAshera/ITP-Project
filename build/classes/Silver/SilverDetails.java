	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			while(rs.next()){
				...
				silver.setBed(rs.getString(4));
				silver.setAvatar(rs.getString(5));
				silver.setPath(rs.getString(6));
				silver.setD1(rs.getString(7));
				silver.setD2(rs.getString(8));
				silver.setD3(rs.getString(9));
