		...
		if (conn == null) {
			...
			try {
				...
				if (rs.next()) {
					...
					String sql2 = "insert into silver (pname,pid,person,bed,avatar,path,d1,d2,d3)"
							+ "values (?,?,?,?,?,?,?,?,?)";
					...
					pre.setString(5, silver.getAvatar());
					pre.setString(6, silver.getPath());
					pre.setString(7, silver.getD1());
					pre.setString(8, silver.getD2());
					pre.setString(9, silver.getD3());
