...
/**
 * Servlet implementation class SilverV
 */
@WebServlet("/SilverV")
public class SilverV extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = "select pid,avatar,d1,d2,d3 from silver where person='10' and bed='5' ";
