...
/**
 * Servlet implementation class Platinum_View
 */
@WebServlet("/Platinum_View")
public class Platinum_View extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Platinum_View() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = "select pid,avatar,d1,d2,d3,d4,d5,d6,d7 from platinum where person='6' and bed='3' ";
