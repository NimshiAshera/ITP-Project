...
public class AdventureRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		adventure.setSeason(request.getParameter("season"));
		adventure.setSee(request.getParameter("see"));
		adventure.setTime(request.getParameter("time"));
				...
				if (conn == null) {
					...
					try {
						...
						if (rs.next()) {
							...
							String sql2 = "insert into adventure (part,name,contact_no,avatar,path,details,season,see,time,avb,username,password)"
									+ "values (?,?,?,?,?,?,?,?,?,?,?,?)";
							...
							pre.setString(7, adventure.getSeason());
							pre.setString(8, adventure.getSee());
							pre.setString(9, adventure.getTime());
							pre.setString(10, adventure.getAvb());
							pre.setString(11, adventure.getUsername());
							pre.setString(12, adventure.getPassword());
