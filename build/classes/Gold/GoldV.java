...
/**
 * Servlet implementation class GoldV
 */
@WebServlet("/GoldV")
public class GoldV extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = "select pid,avatar,d1,d2,d3,d4,d5 from gold where person='10' and bed='5' ";
