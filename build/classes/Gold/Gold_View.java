...
/**
 * Servlet implementation class Gold_View
 */
@WebServlet("/Gold_View")
public class Gold_View extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = "select pid,avatar,d1,d2,d3,d4,d5 from gold where person='6' and bed='3' ";
