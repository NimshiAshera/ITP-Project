	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			while(rs.next()){
				...
				gold.setBed(rs.getString(4));
				gold.setAvatar(rs.getString(5));
				gold.setPath(rs.getString(6));
				gold.setD1(rs.getString(7));
				gold.setD2(rs.getString(8));
				gold.setD3(rs.getString(9));
				gold.setD4(rs.getString(10));
				gold.setD5(rs.getString(11));
