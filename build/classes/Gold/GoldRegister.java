		...
		if (conn == null) {
			...
			try {
				...
				if (rs.next()) {
					...
					String sql2 = "insert into gold (pname,pid,person,bed,avatar,path,d1,d2,d3,d4,d5)"
							+ "values (?,?,?,?,?,?,?,?,?,?,?)";
					...
					pre.setString(5, gold.getAvatar());
					pre.setString(6, gold.getPath());
					pre.setString(7, gold.getD1());
					pre.setString(8, gold.getD2());
					pre.setString(9, gold.getD3());
					pre.setString(10, gold.getD4());
					pre.setString(11, gold.getD5());
