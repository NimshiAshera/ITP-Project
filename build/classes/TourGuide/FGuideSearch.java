...
/**
 * Servlet implementation class FGuideSearch
 */
@WebServlet("/FGuideSearch")
public class FGuideSearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            PreparedStatement ps=conn.prepareStatement("select * from foreign_guide_booking where gname =?");
            ...
            out.print("<center><h1>Bookings of Tour Guide</h1></center>");
            
            out.println("<div class=\"table100\">\r\n"); 
            out.print("<table border=0; width=100%;><tr><th class=\"cell100 column1\">First Name of Customer</th><th class=\"cell100 column2\">Contact No.</th><th class=\"cell100 column3\">Email</th><th class=\"cell100 column4\">Guide Name</th><th class=\"cell100 column5\">Booked Date</th><th class=\"cell100 column6\">No. of Days Booked</th><th class=\"cell100 column7\">Total Amount (USD)</th></tr>");
