...
/**
 * Servlet implementation class LGuideSearch
 */
@WebServlet("/LGuideSearch")
public class LGuideSearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            PreparedStatement ps=conn.prepareStatement("select * from local_guide_booking where gname =?");
