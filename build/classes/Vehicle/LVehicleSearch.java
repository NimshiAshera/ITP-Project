 ...
 */
@WebServlet("/LVehicleSearch")
public class LVehicleSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LVehicleSearch() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
               ...
               PreparedStatement ps=conn.prepareStatement("select * from local_vehicle_booking where vname =?");
