		...
		if (conn == null) {
			...
			try {
				...
				if (rs.next()) {
					...
					String sql2 = "insert into vehicle (fname,lname,phone,email,type,status,noPlate,avatar,path,part,features,terms,username,password)"
							+ "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
					...
					pre.setString(4,  vehicle.getEmail());
					pre.setString(5, vehicle.getType());
					pre.setString(6, vehicle.getStatus());
					pre.setString(7, vehicle.getNoPlate());
					...
					pre.setString(8, vehicle.getAvatar());
					pre.setString(9, vehicle.getPath());
					pre.setString(10, vehicle.getPart());
					pre.setString(11, vehicle.getFeatures());
					pre.setString(12, vehicle.getTerms());
					pre.setString(13, vehicle.getUsername());
					pre.setString(14, vehicle.getPassword());
