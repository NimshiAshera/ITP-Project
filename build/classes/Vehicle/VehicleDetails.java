	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			while(rs.next()){
				...
				vehicle.setEmail(rs.getString(4));
				vehicle.setType(rs.getString(5));
				vehicle.setStatus(rs.getString(6));
				vehicle.setNoPlate(rs.getString(7));
				vehicle.setAvatar(rs.getString(8));
				vehicle.setPath(rs.getString(9));
				vehicle.setPart(rs.getString(10));
				vehicle.setFeatures(rs.getString(11));
				vehicle.setTerms(rs.getString(12));
				vehicle.setUsername(rs.getString(13));
				vehicle.setPassword(rs.getString(14));
			}
